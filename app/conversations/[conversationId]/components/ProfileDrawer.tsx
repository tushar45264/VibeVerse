...
interface ProfileDrawerInterface{
    isOpen: boolean;
    onClose:()=>void;
    data:Conversation &{
        users:user[]
...
const ProfileDrawer:React.FC<ProfileDrawerInterface>=({
    isOpen,
    onClose,
    data
})=>{
    ...
    return (
        <>  
           <ConfirmModel isOpen={confirmOpen}
           onClose={()=> setconfirmOpen(false)} />
            <Transition.Root show={isOpen} as={Fragment}>
                <Dialog as="div" className="relative z-50" onClose={onClose}>
                    <Transition.Child as={Fragment} enter="ease-out duration-500"
                    enterFrom="opacity-0" enterTo="opacity-100" leave="ease-in duration-500" leaveFrom="opacity-100"
                    leaveTo="opacity-0"
                    >
                                                                    ...
                                                                    <> <hr />
                                                                        <div>
                                                                            ...
                                                                            {data.users.map((user, index) => [
                                                                                        ...
                                                                                        index < data.users.length - 1 && <br key={`br-${index}`} />
                                                                                    ])}
                                                                            </dd>
                                                                        </div>
                                                                        </> 
